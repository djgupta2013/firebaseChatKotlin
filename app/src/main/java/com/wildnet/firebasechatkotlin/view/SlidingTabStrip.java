...
class SlidingTabStrip extends LinearLayout {
  ...
  private HSVSlidingTabLayout.TabColorizer mCustomTabColorizer;
  ...
  void setCustomTabColorizer(HSVSlidingTabLayout.TabColorizer customTabColorizer) {
  ...
  protected void onDraw(Canvas canvas) {
    ...
    final HSVSlidingTabLayout.TabColorizer tabColorizer =
  ...
  private static class SimpleTabColorizer implements HSVSlidingTabLayout.TabColorizer {
